...
class UpdateReleaseNamingRegexRequest extends FormRequest
{
    ...
    {
        return [
            'id' => ['required', 'integer', 'exists:release_naming_regexes,id'],
    ...
    {
        return [
            'id.required' => 'The release naming regex ID is required.',
            'id.exists' => 'The specified release naming regex does not exist.',
